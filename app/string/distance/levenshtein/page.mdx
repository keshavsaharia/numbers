...
import { LevenshteinDistance } from '@/components/string/distance/levenshtein'
...
export const metadata = getMetadata(stringDistance, 'levenshtein')
...
<BigOComplexityTable algorithms={stringDistance.sections} selected="levenshtein"/>
