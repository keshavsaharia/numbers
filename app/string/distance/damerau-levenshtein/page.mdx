...
export const metadata = getMetadata(stringDistance, 'damerau-levenshtein')
...
<BigOComplexityTable algorithms={stringDistance.sections} selected="damerau-levenshtein"/>
