...
Regardless of which human representation you choose, a computer will represent that number in **base 2**, with only the digits 0 and 1. This roughly corresponds to the presence or absence of an electrical current.
