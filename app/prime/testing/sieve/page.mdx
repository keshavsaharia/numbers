...
This comes from the fact that each number is crossed out approximately $$\log \log n$$ times. The space complexity is $$O(n)$$, as we need to maintain a boolean array of size $$n$$.
