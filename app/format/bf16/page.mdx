...
The **bfloat16 (BF16)** format is a 16-bit floating-point representation designed for machine learning and numerical computing. Unlike the [IEEE 754](/spec/ieee/754) half-precision ([FP16](/format/fp16)) format, BF16 prioritizes range over precision, with a much higher proportion of bits allocated toward the exponent as compared to other floating point formats.
