...
export function Gauge({
  ...
  return (
    <svg
      ...
      fill='none'
      className={clsx('', typeof className === 'string' ? className : className?.svgClassName)}
      {...props}
    >
      {/*secondary*/}
      <circle
        ...
        className={clsx('', typeof className === 'object' && className?.secondaryClassName)}
      />
      ...
      <circle
        ...
        className={clsx('', typeof className === 'object' && className?.primaryClassName)}
      />
      ...
      {showValue && (
        <text
          ...
          fill='currentColor'
          fontSize={36}
          className={clsx('font-semibold', typeof className === 'object' && className?.textClassName)}
        >
