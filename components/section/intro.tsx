...
export function IntroSection() {
    return (
        ...
        <div className="flex-1">
            ...
            <Paragraph>
                This is essential information for software developers, but particularly for those working on the internals of LLMs, machine learning systems, and database technology. You can safely use any of the code and information on this website in any commercial setting without any <Link href="https://github.com/keshavsaharia/numbers">licensing</Link> requirements.
            </Paragraph>
        </div>
      </motion.section>
    )
